...
public class StudentTest {
  ...
  void testFind(VertxTestContext testContext) {
    Future<HttpResponse<Buffer>> future = webClient.get("/private/api/Student/find")
  ...
  void testSave(VertxTestContext testContext) {
    ...
    multiMap.add("id", "1");
    multiMap.add("cid", "1");
    multiMap.add("nickname", "1");
    multiMap.add("age", "1");
    Future<HttpResponse<Buffer>> future = webClient.post("/private/api/Student/save")
      .addQueryParam(Constant.USER_ID_KEY, Constant.USER_ID_VALUE)
      .addQueryParam(Constant.USER_TOKEN_KEY, Constant.USER_TOKEN_VALUE)
      .sendForm(multiMap);
    future
  ...
  void testGet(VertxTestContext testContext) {
    Future<HttpResponse<Buffer>> future = webClient.get("/private/api/Student/get")
      .addQueryParam(Constant.USER_ID_KEY, Constant.USER_ID_VALUE)
      .addQueryParam(Constant.USER_TOKEN_KEY, Constant.USER_TOKEN_VALUE)
  ...
  void testDelete(VertxTestContext testContext) {
    ...
    Future<HttpResponse<Buffer>> future = webClient.post("/private/api/Student/delete")
      .addQueryParam(Constant.USER_ID_KEY, Constant.USER_ID_VALUE)
      .addQueryParam(Constant.USER_TOKEN_KEY, Constant.USER_TOKEN_VALUE)
      .sendForm(multiMap);
    future
